...
@section('header', 'Create Purchase Order')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="text" value="{{ $poNumber }}" disabled class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50">
            </div>
            <div>
...
document.getElementById('add-item').addEventListener('click', function() {
    ...
    newRow.querySelector('.item-cylinder').addEventListener('change', () => updateCost(newRow));
    newRow.querySelector('.item-type').addEventListener('change', () => updateCost(newRow));
    newRow.querySelector('.item-qty').addEventListener('input', () => updateTotal(newRow));
    newRow.querySelector('.item-cost').addEventListener('input', () => updateTotal(newRow));
