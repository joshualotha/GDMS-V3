...
@section('content')
<form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="max-w-xl bg-white rounded-lg shadow p-6 space-y-6">
    @csrf
    @method('PUT')
    ...
    <div>
        <label for="is_active" class="inline-flex items-center">
            <input type="checkbox" name="is_active" id="is_active" value="1" {{ $supplier->is_active ? 'checked' : '' }}
